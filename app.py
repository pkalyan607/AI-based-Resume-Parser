...
#         st.write(f"Error fetching video title: {str(e)}")
#         return ""
...
connection = pymysql.connect(host='localhost',user='root',password='QWERTY@1',db='cv_data')
...
def run():
    ...
    link = '[©Developed by Jagjeet](https://www.linkedin.com/in/jagjeet-singh-718222b2/)'
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                # st.write(res_vid_title)
                # st.write("Embedded YouTube video:")
                # YouTubeVideo(resume_vid)
        ...
        if st.button('Login'):
            if ad_user == 'jagjeet' and ad_password == 'jagjeet123':
                st.success("Welcome Jagjeet !")
